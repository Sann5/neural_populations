...
\begin{IEEEeqnarray}{rCl}
Q(\theta) &=& \sum_{n=1}^N \sum_{j=1}^K \gamma_j(\prescript{n}{}{x})\log w_j P(\prescript{n}{}{x} | z_j , \theta)\\
&=& \sum_{n=1}^N \sum_{j=1}^K \gamma_j(\prescript{n}{}{x})\log w_j \prod_{i=1}^M \frac{\lambda_{ji}^{\prescript{n}{}{x_i}} e^{-\lambda_{ji}}}{\prescript{n}{}{x_i}!}\\
...
&=& \frac{\delta}{\delta \lambda_{ji}} \sum_{n=1}^N \gamma_j(\prescript{n}{}{x}) \bigg( \log w_j + {\prescript{n}{}{x_i}} \log \lambda_{ji} -\lambda_{ji} - \log(\prescript{n}{}{x_i}!)\bigg) \label{before_deriv}\\
...
\begin{IEEEeqnarray}{rCl}
\lambda_{ji} &=& \frac{\sum_{n=1}^{N} \gamma_j(\prescript{n}{}{x}) \prescript{n}{}{x_i}}{\sum_{n=1}^{N} \gamma_j(\prescript{n}{}{x})}\\
w_j &=& \frac{\sum_{n=1}^{N} \gamma_j(\prescript{n}{}{x})}{N}
\end{IEEEeqnarray}
